...
class ResetPasswords{
    ...
    public function __construct(){
        ...
        $this->mail->Port = 2525;
        $this->mail->Username = '462d078f06f297';
        $this->mail->Password = '0e340af95cf33e';
    }
    ...
    public function sendEmail(){
        ...
        $this->mail->setFrom('ria@magento360.com');
    ...
    public function resetPassword(){
        ...
        flash("newReset", "Password Updated! Login Again", 'form-message form-message-green');
        redirect($url);
    }
}
